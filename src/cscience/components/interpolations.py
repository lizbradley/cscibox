...
class InterpolateModelRegression(cscience.components.BaseComponent):
    ...
    def run_component(self, core):
        ...
        core['all']['age/depth model'] = PointlistInterpolation([i for i in x], [y_intcpt + slope * i for i in x])
...
class InterpolateModelCubic(cscience.components.BaseComponent):
    ...
    def run_component(self, core):
        ...
        core['all']['age/depth model'] = PointlistInterpolation(new_x, interp_func(new_x)) 
