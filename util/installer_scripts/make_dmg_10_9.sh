...
cd /Users/cscience/Projects/Calvin/src
#Make sure we have the most recent version
git pull
#Remove any old dist folders
rm -r /Users/cscience/Projects/Calvin/src/dist*
#Run the pyinstaller script. I didn't write this,
#and was told to ignore all errors
/Users/cscience/Projects/Calvin/src/pyinstaller_script_osx.sh
#Copy the correct icon onto the app
cp /Users/cscience/Projects/Calvin/icon.icns /Users/cscience/Projects/Calvin/src/dist/cscience.app/Contents/Resources/icon-windowed.icns
...
STAGING_DIR="/Users/cscience/Projects/DMG_Creation/CSciBox"
    
rm -rf "${STAGING_DIR}" "${DMG_TMP}" "${DMG_FINAL}"

mkdir -p "${STAGING_DIR}"

mv /Users/cscience/Projects/Calvin/src/dist/cscience.app "${STAGING_DIR}"
...
rm /Users/cscience/Projects/DMG_Creation/CSciBox*

mv /Users/cscience/Projects/Calvin/src/CSciBox.dmg /Users/cscience/Projects/DMG_Creation
